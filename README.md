...
- **[balance-tracker](balance-tracker/)**: Infrastructure and deployment logic for the Balance Tracker application, including Terraform for Cloudflare/Entra ID and Ansible for host management.
