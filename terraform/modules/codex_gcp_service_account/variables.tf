...
variable "manage_required_project_services" {
  description = "Whether Terraform should enable the IAM and Secret Manager APIs required by this module."
  type        = bool
  default     = true
}
...
variable "service_account_description" {
  description = "Description for the Codex service account."
  type        = string
  default     = "Service account used by the Codex environment for Terraform workflows."
}

variable "required_project_roles" {
  description = "Project-level IAM roles that are always granted to the Codex service account."
  type        = list(string)
}

variable "additional_project_roles" {
  description = "Additional project-level IAM roles to grant to the Codex service account."
  type        = list(string)
  default     = []
}
...
variable "labels" {
  description = "Additional labels to apply to the Secret Manager secret."
  type        = map(string)
  default     = {}
}
