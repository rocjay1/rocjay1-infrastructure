...
- **[ansible](ansible.md)**: Shared Ansible roles (e.g., `debian_docker_host`) for centralized host configuration, security, and maintenance across various projects.
- **[cloudflare](cloudflare.md)**: Shared Cloudflare configurations and global infrastructure settings (DNSSEC, geo-blocking, Zero Trust Identity Provider).
- **[google-cloud](google-cloud.md)**: Shared GCP infrastructure, including Workload Identity Federation (WIF) and service accounts for automation.
